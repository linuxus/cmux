...
final class AppDelegateShortcutRoutingTests: XCTestCase {
    ...
    func testWindowChromeTitlebarHeightClampsToSharedRange() {
        [WindowChromeMetrics.appTitlebarHeight, WindowChromeMetrics.secondaryTitlebarHeight, MinimalModeChromeMetrics.titlebarHeight, RightSidebarChromeMetrics.titlebarHeight, RightSidebarChromeMetrics.secondaryBarHeight].forEach { XCTAssertEqual($0, WindowChromeMetrics.sharedChromeBarHeight) }
        XCTAssertEqual(WindowChromeMetrics.bonsplitTabBarHeight, 24); XCTAssertEqual(WindowChromeMetrics.clampedTitlebarHeight(12), 28)
